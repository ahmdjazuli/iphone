...
<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    $ubah =  mysqli_query($kon,"UPDATE datahp SET nama = '$nama', rilis = '$rilis', layar = '$layar', chipset = '$chipset', ram = '$ram', internal = '$internal', eksternal = '$eksternal', kamera = '$kamera', baterai = '$baterai', harga = '$harga', jumlah = '$jumlah'  WHERE idhp = '$idhp'");
