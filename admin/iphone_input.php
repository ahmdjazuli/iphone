  ...
  <div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
              <label>RAM, Foto dan Memori</label>
              <div class="input-group input-group-mb">
                <div class="input-group-prepend" style="width: 50%">
...
<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    $tambah = mysqli_query($kon, "INSERT INTO datahp (nama, rilis, layar, chipset, ram, internal, eksternal, kamera, baterai, harga, jumlah, foto) VALUES ('$nama','$rilis','$layar','$chipset','$ram','$internal','$eksternal','$kamera','$baterai','$harga','$jumlah', '$lokasi')");
